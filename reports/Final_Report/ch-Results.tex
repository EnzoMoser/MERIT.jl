...
\begin{figure}[h!]
    \begin{tabular}{cc}
        \subfloat[Unedited Points]{\includegraphics[width=0.45\linewidth]{PointsUnedited.png}}&
        \subfloat[Edited Points]{\includegraphics[width=0.45\linewidth]{PointsEdited.png}}
    \end{tabular}
...
\begin{figure}[h!]
    \begin{tabular}{cc}
        \subfloat[Unedited Frequencies]{\includegraphics[width=0.45\linewidth]{FrequencyUnedited.png}}&
        \subfloat[Edited Frequencies]{\includegraphics[width=0.45\linewidth]{FrequencyEdited.png}}
    \end{tabular}
