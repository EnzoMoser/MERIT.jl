...
# !This function is also deprecated in favour of the type agnostic function below
...
#A type agnostic implimentation of get_delays
...
#! This function is deprecated in favour of the type agnostic function below
...
#         delay_signal!(delayedSignals ,signals, delays[:, :, pointsIdx], frequencies)
...
function beamform(scan::BreastScan{<:AbstractFloat, <:Number, <:Integer})
    ...
    delays = scan.delayFunc(scan.channels, scan.antennas, scan.relative_permiativity, scan.points)
